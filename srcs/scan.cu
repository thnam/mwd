...
__global__
void gpu_sum_scan_blelloch(double* const d_out, const double* const d_in,
	double* const d_block_sums, const size_t numElems) {
...
__global__
void gpu_prescan(double* const d_out, const double* const d_in,
	double* const d_block_sums, const unsigned int len,
	const unsigned int shmem_sz, const unsigned int max_elems_per_block) {
